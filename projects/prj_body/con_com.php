...
$con_com = $_SESSION['conComID'];

// Get the result...
if (
    $result = $server_conn->query('SELECT * FROM project LEFT JOIN constructionCompany ON project.conComID = constructionCompany.conComID
    WHERE project.conComID = ' . $con_com . ' ORDER BY ' . $column . ' ' . $sort_order)
) {

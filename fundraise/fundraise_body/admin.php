...
if (
    ...
    <div>
        ...
        <table>
            <tr>
                <th><a href="fundraise.php?column=fundRaiseID&order=<?php echo $asc_or_desc; ?>">ID<i
                            class="fas fa-sort<?php echo $column == 'fundRaiseID' ? '-' . $up_or_down : ''; ?>"></i></a>
                </th>
            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    <td<?php echo $column == 'fundRaiseID' ? $add_class : ''; ?>>
                        <?php echo $row['fundRaiseID']; ?>
                        </td>
                            ...
                            <td<?php echo $column == 'Description' ? $add_class : ''; ?>>
                                ...
                                <td<?php echo $column == 'EventDate' ? $add_class : ''; ?>>
                                    ...
                                    <td<?php echo $column == 'adminID' ? $add_class : ''; ?>>
                                        ...
                                        <td>
                                            <a href="update.php?id=<?php echo $row['fundRaiseID']; ?>">Edit</a>&nbsp;
                                            <a href="delete.php?id=<?php echo $row['fundRaiseID']; ?>">Delete</a>
                                        </td>
                </tr>
            <?php endwhile; ?>
        </table>

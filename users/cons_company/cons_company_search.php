    ...
    <div class="content">
        ...
        if (isset($_POST['save'])) {
            ...
            if (!empty($_POST['search'])) {
                ...
                $search_sql = $server_conn->prepare("SELECT * FROM constructionCompany WHERE (conComID LIKE '%$search%') OR (ComName LIKE '%$search%') OR
                (RegNo LIKE '%$search%') OR (TIN LIKE '%$search%') OR (TelNo LIKE '%$search%') OR (Email LIKE '%$search%') OR (PostalAddress LIKE '%$search%')");
                    ...
                    <tbody>
                        ...
                        if (!$search_details) {
                            ...
                            foreach ($search_details as $key => $value) {
                                ...
                                <tr>
                                    <td>
                                        <?php echo $value['conComID']; ?>
                                    </td>

                                    <td>
                                        <?php echo $value['ComName']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="update.php?id=<?php echo $value['conComID']; ?>">Edit</a>
                                    </td>
                                </tr>

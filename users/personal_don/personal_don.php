...
$columns = array('donorID', 'FName', 'LName', 'NIC', 'DOB', 'Gender', 'TelNo', 'Email', 'PostalAddress');
...
<body>
    ...
    if (isset($_SESSION['adminID'])) {
        ...
        <div class="content">
            ...
            // Get the result...
            if (
                $result = $server_conn->query('SELECT * FROM personalDonor ORDER BY ' . $column . ' ' . $sort_order)
            ) {
                ...
                <div>
                    <h2>All Personal Donors</h2>
                    <table>
                        <tr>
                            <th><a href="personal_don.php?column=donorID&order=<?php echo $asc_or_desc; ?>">ID<i
                                        class="fas fa-sort<?php echo $column == 'donorID' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=FName&order=<?php echo $asc_or_desc; ?>">First Name<i
                                        class="fas fa-sort<?php echo $column == 'FName' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=LName&order=<?php echo $asc_or_desc; ?>">Last Name<i
                                        class="fas fa-sort<?php echo $column == 'LName' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=NIC&order=<?php echo $asc_or_desc; ?>">NIC<i
                                        class="fas fa-sort<?php echo $column == 'NIC' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=DOB&order=<?php echo $asc_or_desc; ?>">Date Of Birth<i
                                        class="fas fa-sort<?php echo $column == 'DOB' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=Gender&order=<?php echo $asc_or_desc; ?>">Gender<i
                                        class="fas fa-sort<?php echo $column == 'Gender' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=TelNo&order=<?php echo $asc_or_desc; ?>">Phone<i
                                        class="fas fa-sort<?php echo $column == 'TelNo' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=Email&order=<?php echo $asc_or_desc; ?>">Email<i
                                        class="fas fa-sort<?php echo $column == 'Email' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="personal_don.php?column=PostalAddress&order=<?php echo $asc_or_desc; ?>">Postal
                                    Address<i
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                <td<?php echo $column == 'donorID' ? $add_class : ''; ?>>
                                    <?php echo $row['donorID']; ?>
                                    </td>
                                                        ...
                                                        <td<?php echo $column == 'TelNo' ? $add_class : ''; ?>>
                                                            ...
                                                            <td<?php echo $column == 'Email' ? $add_class : ''; ?>>
                                                                ...
                                                                <td<?php echo $column == 'PostalAddress' ? $add_class : ''; ?>>
                                                                    ...
                                                                    <td>
                                                                        <a
                                                                            href="update.php?id=<?php echo $row['donorID']; ?>">Edit</a>
                                                                    </td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
            ...
            <h3>Total:
                ...
                $total_rec = "SELECT COUNT(donorID) FROM personalDonor";

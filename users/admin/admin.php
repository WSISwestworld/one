...
$columns = array('adminID', 'FName', 'LName', 'Designation', 'NIC', 'DOB', 'TelNo', 'Email', 'PostalAddress', 'Gender');
...
<body>
    ...
    if (isset($_SESSION['adminID'])) {
        ...
        <div class="content">
            ...
            // Get the result...
            if (
                $result = $server_conn->query('SELECT * FROM admin ORDER BY ' . $column . ' ' . $sort_order)
            ) {
                ...
                <div>
                    ...
                    <table>
                        <tr>
                            <th><a href="admin.php?column=adminID&order=<?php echo $asc_or_desc; ?>">Admin ID<i
                                        class="fas fa-sort<?php echo $column == 'adminID' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=FName&order=<?php echo $asc_or_desc; ?>">First Name<i
                                        class="fas fa-sort<?php echo $column == 'FName' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=LName&order=<?php echo $asc_or_desc; ?>">Last Name<i
                                        class="fas fa-sort<?php echo $column == 'LName' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=Designation&order=<?php echo $asc_or_desc; ?>">Designation<i
                                        class="fas fa-sort<?php echo $column == 'Designation' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=NIC&order=<?php echo $asc_or_desc; ?>">NIC<i
                                        class="fas fa-sort<?php echo $column == 'NIC' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=DOB&order=<?php echo $asc_or_desc; ?>">Date Of Birth<i
                                        class="fas fa-sort<?php echo $column == 'DOB' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=Gender&order=<?php echo $asc_or_desc; ?>">Gender<i
                                        class="fas fa-sort<?php echo $column == 'Gender' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=TelNo&order=<?php echo $asc_or_desc; ?>">Phone<i
                                        class="fas fa-sort<?php echo $column == 'TelNo' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=Email&order=<?php echo $asc_or_desc; ?>">Email<i
                                        class="fas fa-sort<?php echo $column == 'Email' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="admin.php?column=PostalAddress&order=<?php echo $asc_or_desc; ?>">Postal Address<i
                                ...
                                <td<?php echo $column == 'adminID' ? $add_class : ''; ?>>
                                    ...
                                    <td<?php echo $column == 'FName' ? $add_class : ''; ?>>
                                        ...
                                        <td<?php echo $column == 'LName' ? $add_class : ''; ?>>
                                            ...
                                            <td<?php echo $column == 'Designation' ? $add_class : ''; ?>>

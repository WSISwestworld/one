...
$columns = array('orgDonorID', 'OrgName', 'RegNo', 'Category', 'TIN', 'TelNo', 'Email', 'PostalAddress');
...
<body>
    ...
    if (isset($_SESSION['adminID'])) {
        ...
        <div class="content">
            ...
            // Get the result...
            if (
                $result = $server_conn->query('SELECT * FROM organizationalDonor ORDER BY ' . $column . ' ' . $sort_order)
            ) {
                ...
                <div>
                    <h2>All Organizational Donors</h2>
                    <table>
                        <tr>
                            <th><a href="org_don.php?column=orgDonorID&order=<?php echo $asc_or_desc; ?>">ID<i
                                        class="fas fa-sort<?php echo $column == 'orgDonorID' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=OrgName&order=<?php echo $asc_or_desc; ?>">Organization Name<i
                                        class="fas fa-sort<?php echo $column == 'OrgName' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=RegNo&order=<?php echo $asc_or_desc; ?>">Registration Number<i
                                        class="fas fa-sort<?php echo $column == 'RegNo' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=Category&order=<?php echo $asc_or_desc; ?>">Category<i
                                        class="fas fa-sort<?php echo $column == 'Category' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=TIN&order=<?php echo $asc_or_desc; ?>">TIN<i
                                        class="fas fa-sort<?php echo $column == 'TIN' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=TelNo&order=<?php echo $asc_or_desc; ?>">Phone<i
                                        class="fas fa-sort<?php echo $column == 'TelNo' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=Email&order=<?php echo $asc_or_desc; ?>">Email<i
                                        class="fas fa-sort<?php echo $column == 'Email' ? '-' . $up_or_down : ''; ?>"></i></a>
                            </th>

                            <th><a href="org_don.php?column=PostalAddress&order=<?php echo $asc_or_desc; ?>">Postal Address<i
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                <td<?php echo $column == 'orgDonorID' ? $add_class : ''; ?>>
                                    <?php echo $row['orgDonorID']; ?>
                                    </td>

                                    <td<?php echo $column == 'OrgName' ? $add_class : ''; ?>>
                                        ...
                                        <td<?php echo $column == 'RegNo' ? $add_class : ''; ?>>
                                            ...
                                            <td<?php echo $column == 'Category' ? $add_class : ''; ?>>
                                                <?php echo $row['Category']; ?>
                                                </td>

                                                <td<?php echo $column == 'TIN' ? $add_class : ''; ?>>
                                                    <?php echo $row['TIN']; ?>
                                                    </td>
                                                    ...
                                                    <td<?php echo $column == 'TelNo' ? $add_class : ''; ?>>
                                                        ...
                                                        <td<?php echo $column == 'Email' ? $add_class : ''; ?>>
                                                            ...
                                                            <td<?php echo $column == 'PostalAddress' ? $add_class : ''; ?>>
                                                                ...
                                                                <td>
                                                                    <a
                                                                        href="update.php?id=<?php echo $row['orgDonorID']; ?>">Edit</a>
                                                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
            ...
            <h3>Total:
                ...
                $total_rec = "SELECT COUNT(orgDonorID) FROM organizationalDonor";

    ...
    <div class="content">
        ...
        if (isset($_POST['save'])) {
            ...
            if (!empty($_POST['search'])) {
                ...
                $search_sql = $server_conn->prepare("SELECT * FROM organizationalDonor WHERE (orgDonorID LIKE '%$search%') OR (OrgName LIKE '%$search%') OR
                (RegNo LIKE '%$search%') OR (Category LIKE '%$search%') OR (TIN LIKE '%$search%') OR (TelNo LIKE '%$search%') OR (Email LIKE '%$search%') OR (PostalAddress LIKE '%$search%')");
                        ...
                        if (!$search_details) {
                            ...
                            foreach ($search_details as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update.php?id=<?php echo $value['orgDonorID']; ?>">Edit</a>
                                    </td>
                                </tr>

...
function data_submission()
{
    ...
    $orgDonorID = test_input($_POST["orgDonorID"]);
    ...
    elseif (mysqli_num_rows($result_check_email) > 0) {
        ...
        if ($row['Email'] === $Email) {
            ...
            $regErr = "Given 'Email Address' is already registered with the system";
        }
    ...
    elseif (mysqli_num_rows($result_check_regno) > 0) {
        ...
        if ($row['RegNo'] === $RegNo) {
            ...
            $regErr = "Given 'Registration Number' is already registered with the system";
        }
            ...
            <div class="content">
                ...
                <form action="" method="POST">
                    ...
                    <fieldset>
                        ...
                        <input type="hidden" name="orgDonorID" value="<?php echo $orgDonorID; ?>">
                        <br>
                        <br>

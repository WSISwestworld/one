    ...
    <div class="content">
        ...
        if (isset($_POST['save'])) {
            ...
            if (!empty($_POST['search'])) {
                ...
                $search_sql = $server_conn->prepare("SELECT * FROM infoProvider WHERE (userID LIKE '%$search%') OR (FName LIKE '%$search%') OR (LName LIKE '%$search%') OR (Province LIKE '%$search%') OR
                (NIC LIKE '%$search%') OR (DOB LIKE '%$search%') OR (TelNo LIKE '%$search%') OR (Email LIKE '%$search%') OR (PostalAddress LIKE '%$search%') OR (Username LIKE '%$search%') OR (Gender LIKE '%$search%')");
                        ...
                        if (!$search_details) {
                            ...
                            foreach ($search_details as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="update.php?id=<?php echo $value['userID']; ?>">Edit</a>
                                    </td>
                                </tr>

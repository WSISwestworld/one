...
$columns = array('IssueType', 'District', 'Location', 'DurationOfIssue', 'Description', 'AwareMethod', 'Status', 'userID', 'adminID');
...
<body>
    ...
    if (isset($_SESSION['adminID'])) {
        ...
        <div class="content">
            ...
            include_once "wsi_body/admin.php";
            ?>

            <div>
                <a href="../complient_form/complient.php">Add New Water Supply Issue</a>
            </div>
    ...
    elseif (isset($_SESSION['conComID'])) {
        ...
        <div class="content">
            ...
            <?php
            include_once "wsi_body/con_com.php";
            ?>
